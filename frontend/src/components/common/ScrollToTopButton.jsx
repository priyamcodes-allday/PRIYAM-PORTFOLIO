...
export default function ScrollToTopButton() {
  ...
  return (
    ...
    >
      <div
        ref={buttonRef}
        className="h-full w-full [transform:translate3d(var(--magnet-x,0px),var(--magnet-y,0px),0)_scale(var(--magnet-scale,1))]"
      >
        <button
          type="button"
        ...
        >
          <ChevronUp
            aria-hidden="true"
            size={18}
            className="transition-transform duration-300 ease-out group-hover:-translate-y-0.5 motion-reduce:translate-none motion-reduce:transform-none motion-reduce:transition-none"
          />
        </button>
      </div>
    </div>
